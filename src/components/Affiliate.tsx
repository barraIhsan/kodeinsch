...
export default function Affiliate() {
  return (
    <>
      <section className="flex flex-col xl:flex-row justify-between container mx-auto px-14 pt-60 gap-28">
        <div className="">
          <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">
            Afiliasi Kami
          </h2>
          <p className="text-gray-400 text-justify text-lg md:text-xl  font-thin max-w-3xl">
      ...
      <section className="flex flex-col md:flex-row justify-between items-center container mx-auto px-14 py-64 gap-20 md:gap-16">
        <iframe
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-400 text-justify text-lg md:text-xl font-thin max-w-2xl">
