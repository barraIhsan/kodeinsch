        ...
        <>
            <section className="flex justify-between container mx-auto px-14 pt-60">
                <div className="">
                    ...
                    <p className="text-[#A0A0A0] text-xl font-thin max-w-3xl pr-10">
            ...
            <section className="flex flex-row-reverse justify-between items-center container mx-auto px-14 py-64">
                ...
                <iframe width="620" height="350" src="https://www.youtube.com/embed/TKXxJbiQpIE?si=VhYwyKnBTNmAOVyr" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" className="rounded-3xl"/>
            </section>
        </>
    );
}