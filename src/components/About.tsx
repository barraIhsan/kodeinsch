...
export default function About() {
  return (
    <div className="2xl:px-32 sm:px-8 lg:px-20 py-12 lg:py-16 2xl:py-24">
      <div className="bg-gradient-to-b from-blue-600 to-blue-700 flex flex-col gap-6 lg:gap-10 shadow-xl rounded-xl size-full px-5 sm:px-12 lg:px-16 py-5 sm:py-48">
        ...
        <section className="flex flex-col items-center pt-12 sm:pt-36">
          ...
          <div className="flex flex-col lg:flex-row gap-12 w-full">
            {curriculums.map((curriculum, index) => (
              <div
                className="bg-white px-8 py-10 rounded-3xl flex-1 min-w-72"
                key={index}
              >
                <Image
                  className="pb-4"
